export const experienceData = [
  ...
  //   duration: "2018 - 2021",
  //   achievements: [
  //     "Developed responsive user interfaces using React and maintained existing web applications",
  //     "Improved application performance by 60% through code optimization",
  //     "Implemented new design system reducing development time by 30%",
  //     "Collaborated with UX team to enhance user experience",
  //   ],
  //   technologies: ["React", "JavaScript", "SASS", "Redux", "Jest", "Webpack"],
  // },
];